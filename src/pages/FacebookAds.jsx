...
function FacebookAds() {
  ...
  return (
    <>
      <Helmet>
        <title>Facebook Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık</title>
        <meta name="description" content="Facebook reklamları ile hedef kitlenize ulaşın. Harkan Media'nın uzman ekibi ile Facebook reklam kampanyalarınızı optimize edin ve dönüşüm oranlarınızı artırın." />
        <meta name="keywords" content="Facebook reklamları, Facebook Ads, sosyal medya reklamları, dijital reklam, Facebook reklam optimizasyonu, İstanbul" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://harkanmedia.vercel.app/facebook-reklam-optimizasyonu" />
        <meta property="og:title" content="Facebook Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="og:description" content="Facebook reklamları ile hedef kitlenize ulaşın. Profesyonel Facebook reklam yönetimi ve optimizasyonu." />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://harkanmedia.vercel.app/facebook-reklam-optimizasyonu" />
        <meta property="twitter:title" content="Facebook Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="twitter:description" content="Facebook reklamları ile hedef kitlenize ulaşın. Profesyonel Facebook reklam yönetimi ve optimizasyonu." />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://harkanmedia.vercel.app/facebook-reklam-optimizasyonu" />
      </Helmet>
