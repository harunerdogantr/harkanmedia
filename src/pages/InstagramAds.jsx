...
function InstagramAds() {
  ...
  return (
    <>
      <Helmet>
        <title>Instagram Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık</title>
        <meta name="description" content="Instagram reklamları ile hedef kitlenize ulaşın. Görsel odaklı reklam kampanyaları, influencer işbirlikleri ve Instagram reklam optimizasyonu ile markanızı büyütün." />
        <meta name="keywords" content="Instagram reklamları, Instagram Ads, sosyal medya reklamları, influencer marketing, Instagram optimizasyonu, İstanbul" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://harkanmedia.vercel.app/instagram-reklam-optimizasyonu" />
        <meta property="og:title" content="Instagram Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="og:description" content="Instagram reklamları ile hedef kitlenize ulaşın. Görsel odaklı reklam kampanyaları ve influencer işbirlikleri ile markanızı büyütün." />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://harkanmedia.vercel.app/instagram-reklam-optimizasyonu" />
        <meta property="twitter:title" content="Instagram Reklamları - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="twitter:description" content="Instagram reklamları ile hedef kitlenize ulaşın. Görsel odaklı reklam kampanyaları ve influencer işbirlikleri ile markanızı büyütün." />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://harkanmedia.vercel.app/instagram-reklam-optimizasyonu" />
      </Helmet>
