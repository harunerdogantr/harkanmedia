  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Veri modelleme ile işletmenizin verilerini anlamlı yapılara dönüştürün. Veri mimarisi, veri modelleme ve veri yönetimi çözümleri ile veri odaklı kararlar alın." />
        <meta name="keywords" content="veri modelleme, veri mimarisi, veri yönetimi, veri analizi, iş zekası, İstanbul" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://harkanmedia.vercel.app/veri-modelleme" />
        <meta property="og:title" content="Veri Modelleme - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="og:description" content="Veri modelleme ile işletmenizin verilerini anlamlı yapılara dönüştürün. Veri mimarisi ve veri yönetimi çözümleri ile veri odaklı kararlar alın." />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://harkanmedia.vercel.app/veri-modelleme" />
        <meta property="twitter:title" content="Veri Modelleme - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="twitter:description" content="Veri modelleme ile işletmenizin verilerini anlamlı yapılara dönüştürün. Veri mimarisi ve veri yönetimi çözümleri ile veri odaklı kararlar alın." />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://harkanmedia.vercel.app/veri-modelleme" />
      </Helmet>
