  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Detaylı dijital pazarlama raporları ile performansınızı takip edin. Özelleştirilmiş raporlama çözümleri, veri görselleştirme ve stratejik içgörüler ile işletmenizi büyütün." />
        <meta name="keywords" content="dijital raporlama, performans raporları, veri görselleştirme, iş analitiği, KPI raporları, İstanbul" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://harkanmedia.vercel.app/raporlama" />
        <meta property="og:title" content="Raporlama - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="og:description" content="Detaylı dijital pazarlama raporları ile performansınızı takip edin. Özelleştirilmiş raporlama çözümleri ile işletmenizi büyütün." />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://harkanmedia.vercel.app/raporlama" />
        <meta property="twitter:title" content="Raporlama - Harkan Media - Dijital Pazarlama ve Yazılım Danışmanlık" />
        <meta property="twitter:description" content="Detaylı dijital pazarlama raporları ile performansınızı takip edin. Özelleştirilmiş raporlama çözümleri ile işletmenizi büyütün." />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://harkanmedia.vercel.app/raporlama" />
      </Helmet>
